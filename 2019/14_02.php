...
1000000000000
130552912856
10000000 => 1305528633058
7500000 => 979146457786



SOLVED BY EDUCATED GUESSING!! :-/

All I did is determine by try and error which number results in the closest *below* one trillion
...
$ore_needed = get_ore_needed_for('FUEL', 7659732);
var_dump($ore_needed);
die("END OF PROGRAM\n");
